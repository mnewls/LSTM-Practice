...
model.compile(optimizer=keras.optimizers.Adam(learning_rate=learning_rate, clipnorm=1.0), loss="mse")
model.summary()
...
print(de_normalize(model.predict(val_x)))